...
SETTING_SPECS: Final[tuple[SettingSpec, ...]] = (
    ...
    SettingSpec(
        ...
        hint=(
            ...
            "когда». Номер или идентификатор группового чата из Wazzup (вида "
            "77010000000-1600000000@g.us). Телефон клиента в эту строку не попадает, "
            "и на сообщения из этого чата бот не отвечает."
        ),
    ),
    SettingSpec(
        key="trial_free",
