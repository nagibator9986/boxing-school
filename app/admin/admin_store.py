...
SETTING_SPECS: Final[tuple[SettingSpec, ...]] = (
    ...
    SettingSpec(
        ...
        hint=(
            ...
            "вопросов, на которые нужен человек. Один номер, в любом виде. Пусто — "
            "карточки идут на номер из настроек сервера (MANAGER_NOTIFY_TARGET). "
            "На сообщения с этого номера бот не отвечает."
        ),
    ),
    SettingSpec(
        key="trial_free",
