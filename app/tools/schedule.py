...
async def get_schedule(
    ...
    *,
    ...
    caveats.append(
        ...
        "Не пересказывай дни и время своими словами и не предлагай записаться: "
        "предложение записи уйдёт клиенту отдельным сообщением сразу после "
        "карточек. Ответь одной короткой фразой по делу."
    )
