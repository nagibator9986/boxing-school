...
async def get_schedule(
    ...
    *,
    ...
    caveats.append(
        ...
        "Не пересказывай дни и время своими словами. Вместо этого сделай "
        "следующий шаг: предложи записать ребёнка на бесплатное пробное занятие "
        "и задай ОДИН короткий вопрос — то, чего ещё не знаешь (имя ребёнка, его "
        "возраст или удобный день). Владелец 10.09.2026: «бот скинул — и всё, "
        "дальше что? Надо ещё одним текстом: давайте запишу ребёнка на пробную»."
    )
