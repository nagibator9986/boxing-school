...
SCENARIOS = [
 ...
 ("03. Приветствие «увидела рекламу» и пункт меню", ChannelKind.INSTAGRAM, [
   (False, "Здравствуйте, увидела рекламу"), (False, "2"), (False, "Ему 9 лет"),
 ]),
 ...
 ("08. Действующий клиент пишет на номер бота", ChannelKind.WHATSAPP, [
   (False, "Здравствуйте, мы уже занимаемся"),
   (False, "Ребёнок болел неделю, перерасчёт будет?"),
 ]),
 ("08a. Утренняя группа для второй смены", ChannelKind.WHATSAPP, [
   (False, "Здравствуйте! Учимся во вторую смену, есть утренние тренировки?"),
   (False, "Северо-запад, ребёнку 9 лет"),
 ]),
 ...
 ("27. Чат с рекламы: новое приветствие «Рады приветствовать вас в Ainazarov Top Team!»", ChannelKind.WHATSAPP, [
   ...
   (False, "Здравствуйте! Хочу записать ребёнка на бесплатную пробную тренировку."),
 ]),
]
